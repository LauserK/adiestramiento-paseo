...
from instructivos.views import CourseView, AddConceptView, AddMaterialView, RemoveConceptView, EditConceptView, EditMaterialView, RemoveMaterialView, ExamenView, AddExamenView, EditExamenView, RemoveExamenView
...
urlpatterns = [
    ...
    url(r'^manager/examen/(?P<examenSlug>[-\w]+)/agregar-material/$', AddExamenView.as_view(), name="add-examenes"),
