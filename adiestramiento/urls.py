...
from instructivos.views import CourseView, AddConceptView, AddMaterialView, RemoveConceptView, EditConceptView
...
urlpatterns = [
    ...
    url(r'^manager/material/(?P<materialSlug>[-\w]+)/editar/$', EditConceptView.as_view(), name="edit-material"),
